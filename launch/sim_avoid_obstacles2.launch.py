...
def generate_launch_description():
    ...
    nav_states_node = Node(
        ...
        parameters=[{'plan_rate_hz': 10.0},
                    ...
                    {'x_coords0':          [3.5, 3.5, 1.8, 0.0]}, # SELECT, east side
                    {'y_coords0':          [1.0, -1.0, -1.0, 0.0]}, # 22 to -10
                    
                    {'waypoint_types':     [1,   1,    1, 0]},
                    {'hill_waypoint_list': [0,   0,    0, 0]},
    ...
    avoid_obs_node = Node(
        ...
        remappings=[('known_obstacle', 'ignore_known_obs')]
    )
